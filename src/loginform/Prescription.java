...
public class Prescription extends javax.swing.JFrame {
     ...
     */
    public Prescription(Connection con,int docId,int patId,java.sql.Date date) {
        this.con = con;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String diagnosis = jTextArea1.getText(); // assuming JavaFX or Swing
        
        try  {
            String sql = "INSERT INTO MedicalRecord (ID, PATIENTID, DOCTORID, ADMISSION, DISCHARGE, DIAGNOSIS) VALUES (Appointment_seq.NEXTVAL, ?, ?, ?, SYSDATE, ?)";
